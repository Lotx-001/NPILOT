...
class nTune():
  ...
  def checkValidCommon(self):
    ...
    if self.checkValue("steerRatio", 15.5):
      updated = True

    if self.checkValue("steerActuatorDelay", 0.1):
      updated = True

    if self.checkValue("steerRateCost", 0.41):
      updated = True
  ...
  def checkValidLQR(self):
    ...
    if self.checkValue("scale", 500.0, 5000.0, 15.5, 1800.0):
      updated = True

    if self.checkValue("ki", 0.0, 0.2, 0.01, 0.03, 0.012):
      updated = True

    if self.checkValue("dcGain", 0.002, 0.004, 0.0275, 0.0285):
      updated = True
