...
class nTune():
  ...
  def checkValidCommon(self):
    ...
    if self.checkValue("steerRateCost", 0.1, 1.5, 0.25, 0.41,):
      updated = True
  ...
  def checkValidLQR(self):
    ...
    if self.checkValue("scale", 500.0, 5000.0, 1600.0, 1800.0, 2000.0):
      updated = True

    if self.checkValue("ki", 0.0, 0.2, 0.01, 0.03, 0.012):
      updated = True

    if self.checkValue("dcGain", 0.002, 0.004, 0.0028, 0.0285):
      updated = True

    if self.checkValue("steerLimitTimer", 0.5, 3.0, 1.2):
      updated = True
